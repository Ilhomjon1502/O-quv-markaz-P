...
import com.ilhomjon.h532oquvmarkaz.databinding.FragmentKursHaqidaBinding
...
lateinit var kurs: Kurs
    ...
    override fun onStart() {
        ...
        binding.txtKursHaqida.text = kurs.about

        binding.btnTalabaQoshish.setOnClickListener {
            val bundle = bundleOf("keyKurs1" to kurs, "keyHas" to 0)
